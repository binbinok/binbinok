...
var RepoList = function (_React$Component) {
    ...
    _createClass(RepoList, [{
        ...
        value: function componentDidMount() {
            ...
            this.props.promise.then(function (data) {
                return _this2.setState({ loading: false, data: data });
...
(0, _reactDom.render)(_react2.default.createElement(RepoList, { promise: _axios2.default.get('https://api.github.com/search/repositories?q=javascript&sort=stars') }), document.getElementById('app'));
